...
this file was created at: 2024-05-17 13:20
...
```bash
# CLONE FROM BRANCH
git clone --branch rocky9-labul-proxmox https://github.com/stuttgart-things/stuttgart-things

# OR CLONE FROM MAIN AFTER A PREVIOUS PR-MERGE
git clone https://github.com/stuttgart-things/stuttgart-things

# CHANGE TO DIR
cd stuttgart-things/packer/builds/rocky9-labul-proxmox/
```
...
packer init packer/builds/rocky9-labul-proxmox-base-os/rocky9-base-os.pkr.hcl

DATE=$(echo $(date +'%Y-%m-%d'))

packer build -force \
-var "name=${DATE}-rocky9-labul-proxmox" \
-var "password=<PASSWORD>" \
-var "password=<PASSWORD>" \
packer/builds/rocky9-labul-proxmox-base-os/rocky9-base-os.pkr.hcl
```
...
cd rocky9-labul-proxmox-base-os/test-vm/
