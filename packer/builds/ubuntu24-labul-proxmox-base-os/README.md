...
this file was created at: 2024-05-21 13:31
...
```bash
# CLONE FROM BRANCH
git clone --branch ubuntu24-labul-proxmox https://github.com/stuttgart-things/stuttgart-things

# OR CLONE FROM MAIN AFTER A PREVIOUS PR-MERGE
git clone https://github.com/stuttgart-things/stuttgart-things

# CHANGE TO DIR
cd stuttgart-things/packer/builds/ubuntu24-labul-proxmox/
```
...
packer init packer/builds/ubuntu24-labul-proxmox-base-os/ubuntu24-base-os.pkr.hcl

DATE=$(echo $(date +'%Y-%m-%d'))

packer build -force \
-var "name=${DATE}-ubuntu24-labul-proxmox" \
-var "password=<PASSWORD>" \
-var "password=<PASSWORD>" \
packer/builds/ubuntu24-labul-proxmox-base-os/ubuntu24-base-os.pkr.hcl
```
...
cd ubuntu24-labul-proxmox-base-os/test-vm/
