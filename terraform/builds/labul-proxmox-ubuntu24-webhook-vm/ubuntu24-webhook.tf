module "ubuntu24-webhook" {
  ...
  pve_network             = "vmbr101"
  vm_notes                = "VSPHERE-VM ubuntu24-webhook ubuntu24-eva BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.ubuntu24-webhook.ip
}
