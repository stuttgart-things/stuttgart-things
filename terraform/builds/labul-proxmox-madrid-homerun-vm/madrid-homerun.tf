module "madrid-homerun" {
  ...
  pve_network             = "vmbr101"
  vm_notes                = "VSPHERE-VM madrid-homerun ubuntu24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.madrid-homerun.ip
}
