module "gh-actions-docker" {
  ...
  pve_network             = "vmbr104"
  vm_notes                = "VSPHERE-VM gh-actions-docker ubuntu24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.gh-actions-docker.ip
}
