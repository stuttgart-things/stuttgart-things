module "rke2-test-molecule" {
  ...
  pve_network             = "vmbr102"
  vm_notes                = "VSPHERE-VM rke2-test-molecule ubuntu24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.rke2-test-molecule.ip
}
