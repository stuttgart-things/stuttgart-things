module "ubuntu-vault-test" {
  ...
  pve_network             = "vmbr104"
  vm_notes                = "VSPHERE-VM ubuntu-vault-test ubuntu24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.ubuntu-vault-test.ip
}
