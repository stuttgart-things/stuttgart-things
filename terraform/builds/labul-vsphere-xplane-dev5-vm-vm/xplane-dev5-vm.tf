module "xplane-dev5-vm" {
  ...
  annotation             = "VSPHERE-VM xplane-dev5-vm sthings-u24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value = [module.xplane-dev5-vm.ip]
}
