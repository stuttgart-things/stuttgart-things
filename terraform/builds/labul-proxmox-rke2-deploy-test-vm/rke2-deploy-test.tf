module "rke2-deploy-test" {
  ...
  pve_network             = "vmbr104"
  vm_notes                = "VSPHERE-VM rke2-deploy-test ubuntu24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.rke2-deploy-test.ip
}
