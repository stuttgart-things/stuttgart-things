module "packer-builder" {
  ...
  pve_network             = "vmbr103"
  vm_notes                = "VSPHERE-VM packer-builder rocky9 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.packer-builder.ip
}
