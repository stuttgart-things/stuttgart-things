module "k3s-andre-test" {
  ...
  annotation             = "VSPHERE-VM k3s-andre-test sthings-u22 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value = [module.k3s-andre-test.ip]
}
