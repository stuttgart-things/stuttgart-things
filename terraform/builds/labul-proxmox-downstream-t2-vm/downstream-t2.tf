module "downstream-t2" {
  ...
  pve_network             = "vmbr104"
  vm_notes                = "VSPHERE-VM downstream-t2 ubuntu24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
