module "rocky9-awx-test2" {
  ...
  pve_network             = "vmbr101"
  vm_notes                = "VSPHERE-VM rocky9-awx-test2 rocky9 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.rocky9-awx-test2.ip
}
