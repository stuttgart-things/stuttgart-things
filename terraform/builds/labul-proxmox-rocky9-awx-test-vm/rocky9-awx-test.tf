module "rocky9-awx-test" {
  ...
  pve_network             = "vmbr101"
  vm_notes                = "VSPHERE-VM rocky9-awx-test rocky9 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value     = module.rocky9-awx-test.ip
}
