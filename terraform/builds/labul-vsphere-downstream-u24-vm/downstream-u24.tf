module "downstream-u24" {
  ...
  annotation             = "VSPHERE-VM downstream-u24 sthings-u24 BUILD w/ TERRAFORM FOR STUTTGART-THINGS"
...
output "ip" {
  value = [module.downstream-u24.ip]
}
