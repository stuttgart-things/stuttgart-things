...
template:
  ...
  cluster: |
    ...
    type: Opaque
    stringData:
        DOMAIN: ENC[AES256_GCM,data:w4KfmzTgGR9rA1nIKGKSlRjCCQpNDwHjy10tvw==,iv:S5nHygDDjrw5jFlkj0UZLakH0J3trURdB0akomb4aEE=,tag:XhD3c0yiStyCa+s6DnUXYw==,type:str]
    sops:
        kms: []
        gcp_kms: []
        azure_kv: []
        ...
        age:
            - recipient: age1g438n4lx6h7x7u42q652e9ygzrkkwlul49e8zsmsrfmxm9k3tvcsykhff4
              enc: |
                -----BEGIN AGE ENCRYPTED FILE-----
                
                -----END AGE ENCRYPTED FILE-----
